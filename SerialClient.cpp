...
int SerialClient::connect(IPAddress ip, uint16_t port) { return 1; }
int SerialClient::connect(const char *host, uint16_t port) { return 1; }
...
uint8_t SerialClient::connected() { return 1; } 
